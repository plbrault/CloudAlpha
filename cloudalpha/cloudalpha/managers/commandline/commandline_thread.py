...
class CommandlineThread(Thread):
    """A thread for running a CommandlineManager instance."""

    manager = None

    def __init__(self, manager):
        """CommandlineThread initializer"""
        self.manager = manager
        super(CommandlineThread, self).__init__()

    def run(self):
        """Start the thread and interpret commands."""
        self.manager.interpret_commands()
